...
public class SkillMasteryObjective extends Objective {

    private String mobToKillType;
    private String nameTagContainsAny = "";
    private String nameTagEquals = "";

    public SkillMasteryObjective(NotQuests main) {
        super(main);
    }
    ...
    public static void handleCommands(NotQuests main, PaperCommandManager<CommandSender> manager, Command.Builder<CommandSender> addObjectiveBuilder) {
        addObjectiveBuilder = addObjectiveBuilder
                ...
                .argument(IntegerArgument.<CommandSender>newBuilder("mastery").withMin(1), ArgumentDescription.of("Mastery to get"))
        ...
        addObjectiveBuilder = addObjectiveBuilder.handler((context) -> {
            ...
            final int amountToLevelUp = context.get("mastery");
    ...
    public String getObjectiveTaskDescription(final QuestPlayer questPlayer) {
        return main.getLanguageManager().getString("chat.objectives.taskDescription.skillMastery.base", questPlayer, Map.of(
                "%MASTERYTOGET%", getSkillToMaster()
        ));
    }
    ...
    public void save(FileConfiguration configuration, String initialPath) {
        configuration.set(initialPath + ".specifics.skillToMaster", getSkillToMaster());
    ...
    public final String getSkillToMaster() {
    ...
    public void load(FileConfiguration configuration, String initialPath) {
        mobToKillType = configuration.getString(initialPath + ".specifics.skillToMaster");
