...
public class ReachSkillLevelObjective extends Objective {

    private String mobToKillType;
    private String nameTagContainsAny = "";
    private String nameTagEquals = "";

    public ReachSkillLevelObjective(NotQuests main) {
        super(main);
    }
    ...
    public static void handleCommands(NotQuests main, PaperCommandManager<CommandSender> manager, Command.Builder<CommandSender> addObjectiveBuilder) {
        addObjectiveBuilder = addObjectiveBuilder
                ...
                .argument(IntegerArgument.<CommandSender>newBuilder("level").withMin(1), ArgumentDescription.of("Level to reach"))
        ...
        addObjectiveBuilder = addObjectiveBuilder.handler((context) -> {
            ...
            final int levelToReach = context.get("level");
            ...
            ReachSkillLevelObjective SkillMasteryObjective = new ReachSkillLevelObjective(main);

            SkillMasteryObjective.setMobToKillType(skillName);
            SkillMasteryObjective.setProgressNeeded(levelToReach);
    ...
    public String getObjectiveTaskDescription(final QuestPlayer questPlayer) {
        return main.getLanguageManager().getString("chat.objectives.taskDescription.skillLevel.base", questPlayer, Map.of(
                "%LEVELTOREACH%", getSkillToLevelUp()
        ));
    }
    ...
    public void save(FileConfiguration configuration, String initialPath) {
        configuration.set(initialPath + ".specifics.skillToLevelReach", getSkillToLevelUp());
    ...
    public void load(FileConfiguration configuration, String initialPath) {
        mobToKillType = configuration.getString(initialPath + ".specifics.skillToLevelReach");
